...
yearly_summary_lulc <- function(site_bmp_deliniated, deliniated_lulc_site_2019, bmp_full_ds, filter_date, lulc_year, site_outline, site_name, year){
  ...
  site_for_summary_ds <-left_join(site_for_summary_ds, bmp_full_ds, by = 'ASSET')
...
write.csv(site_lulc_year_summary, file =paste0( "./Output_for_Files/",site_name, year, "lulcandstorage_yearly_summary.csv"))
...
all_bmp_all_sites_lulc_storage_yearly_summaries<- drop_units(all_bmp_all_sites_lulc_storage_yearly_summaries)%>%
  dplyr::mutate(percent_20_treated = (`20`/total_basin_20)*100, untreated_20 = (total_basin_20 - `20`),
         ...
         percent_20_treated = (`70`/total_basin_70)*100, untreated_70 = (total_basin_70 - `20`))
