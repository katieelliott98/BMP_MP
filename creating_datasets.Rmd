...
tr109_full_ds_stores_2010 <- tr109_full_ds_stores %>%
  filter(FINAL_DATE < "2011-01-01" & year == "2010") %>%
  group_by(year, site) %>%
  summarize(
...
tr109_full_ds_stores_2012 <- tr109_full_ds_stores %>%
  filter(FINAL_DATE < "2013-01-01" & year == "2012") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
            lulc_40 = sum(lulc_40, na.rm = TRUE),
...
tr109_full_ds_stores_2014 <- tr109_full_ds_stores %>%
  filter(FINAL_DATE < "2015-01-01" & year == "2014") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
            lulc_40 = sum(lulc_40, na.rm = TRUE),
...
tr109_full_ds_stores_2016 <- tr109_full_ds_stores %>%
  filter(FINAL_DATE < "2017-01-01" & year == "2016") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
            lulc_40 = sum(lulc_40, na.rm = TRUE),
...
tr109_full_ds_stores_2019 <- tr109_full_ds_stores %>%
  filter(FINAL_DATE < "2020-01-01" & year == "2019") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
            lulc_40 = sum(lulc_40, na.rm = TRUE),
...
stores_lulc_tr109 <- rbind(tr109_full_ds_stores_2010, tr109_full_ds_stores_2011, tr109_full_ds_stores_2012, tr109_full_ds_stores_2013, tr109_full_ds_stores_2014, tr109_full_ds_stores_2015, tr109_full_ds_stores_2016, tr109_full_ds_stores_2017, tr109_full_ds_stores_2018, tr109_full_ds_stores_2019) 
...
tr104_full_ds_stores_2010 <- tr104_full_ds_stores %>%
  filter(FINAL_DATE < "2011-01-01" & year == "2010") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
tr104_full_ds_stores_2012 <- tr104_full_ds_stores %>%
  filter(FINAL_DATE < "2013-01-01" & year == "2012") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
tr104_full_ds_stores_2014 <- tr104_full_ds_stores %>%
  filter(FINAL_DATE < "2015-01-01" & year == "2014") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
tr104_full_ds_stores_2016 <- tr104_full_ds_stores %>%
  filter(FINAL_DATE < "2017-01-01" & year == "2016") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
tr104_full_ds_stores_2019 <- tr104_full_ds_stores %>%
  filter(FINAL_DATE < "2020-01-01" & year == "2019") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
stores_lulc_tr104 <- rbind(tr104_full_ds_stores_2010, tr104_full_ds_stores_2011, tr104_full_ds_stores_2012, tr104_full_ds_stores_2013, tr104_full_ds_stores_2014, tr104_full_ds_stores_2015, tr104_full_ds_stores_2016, tr104_full_ds_stores_2017, tr104_full_ds_stores_2018, tr104_full_ds_stores_2019) 
...
cr_full_ds_stores_2010 <- cr_full_ds_stores %>%
  filter(FINAL_DATE < "2011-01-01" & year == "2010") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
cr_full_ds_stores_2012 <- cr_full_ds_stores %>%
  filter(FINAL_DATE < "2013-01-01" & year == "2012") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
cr_full_ds_stores_2014 <- cr_full_ds_stores %>%
  filter(FINAL_DATE < "2015-01-01" & year == "2014") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
cr_full_ds_stores_2016 <- cr_full_ds_stores %>%
  filter(FINAL_DATE < "2017-01-01" & year == "2016") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
cr_full_ds_stores_2019 <- cr_full_ds_stores %>%
  filter(FINAL_DATE < "2020-01-01" & year == "2019") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
stores_lulc_cr <- rbind(cr_full_ds_stores_2010, cr_full_ds_stores_2011, cr_full_ds_stores_2012, cr_full_ds_stores_2013, cr_full_ds_stores_2014, cr_full_ds_stores_2015, cr_full_ds_stores_2016, cr_full_ds_stores_2017, cr_full_ds_stores_2018, cr_full_ds_stores_2019) 
...
sb_full_ds_stores_2010 <- sb_full_ds_stores %>%
  filter(FINAL_DATE < "2011-01-01" & year == "2010") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
sb_full_ds_stores_2012 <- sb_full_ds_stores %>%
  filter(FINAL_DATE < "2013-01-01" & year == "2012") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
sb_full_ds_stores_2014 <- sb_full_ds_stores %>%
  filter(FINAL_DATE < "2015-01-01" & year == "2014") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
sb_full_ds_stores_2016 <- sb_full_ds_stores %>%
  filter(FINAL_DATE < "2017-01-01" & year == "2016") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
sb_full_ds_stores_2019 <- sb_full_ds_stores %>%
  filter(FINAL_DATE < "2020-01-01" & year == "2019") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
stores_lulc_sb <- rbind(sb_full_ds_stores_2010, sb_full_ds_stores_2011, sb_full_ds_stores_2012, sb_full_ds_stores_2013, sb_full_ds_stores_2014, sb_full_ds_stores_2015, sb_full_ds_stores_2016, sb_full_ds_stores_2017, sb_full_ds_stores_2018, sb_full_ds_stores_2019) 
...
cb_full_ds_stores_2010 <- cb_full_ds_stores %>%
  filter(FINAL_DATE < "2011-01-01" & year == "2010") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
cb_full_ds_stores_2012 <- cb_full_ds_stores %>%
  filter(FINAL_DATE < "2013-01-01" & year == "2012") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
cb_full_ds_stores_2014 <- cb_full_ds_stores %>%
  filter(FINAL_DATE < "2015-01-01" & year == "2014") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
cb_full_ds_stores_2016 <- cb_full_ds_stores %>%
  filter(FINAL_DATE < "2017-01-01" & year == "2016") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
cb_full_ds_stores_2019 <- cb_full_ds_stores %>%
  filter(FINAL_DATE < "2020-01-01" & year == "2019") %>%
  group_by(year, site) %>%
  summarize(
            lulc_70 = sum(lulc_70, na.rm = TRUE),
...
stores_lulc_cb <- rbind(cb_full_ds_stores_2010, cb_full_ds_stores_2011, cb_full_ds_stores_2012, cb_full_ds_stores_2013, cb_full_ds_stores_2014, cb_full_ds_stores_2015, cb_full_ds_stores_2016, cb_full_ds_stores_2017, cb_full_ds_stores_2018, cb_full_ds_stores_2019) 
...
land_use_storage_summarized <- rbind(stores_lulc_tr104, stores_lulc_cr, stores_lulc_sb, stores_lulc_cb, stores_lulc_tr109)

write.csv(land_use_storage_summarized, file = "./Output_for_Files/land_use_storage_summary_by_site_year.csv")
